...
Module ของภาษา Python ที่เราใช้ก็คือ matplotlib กับ csv 
matplotlib ใช้สร้างกราฟมาแสดงในเว็บ เราสามารถสร้างกราฟรูปต่างๆได้ด้วย matplotlib
csv เราใช้ csv ในการดึงข้อมูลจากไฟล์นามสกุล csv มาใช้ในภาษา python
เราได้นำ 2 Module นี้มาสร้างโปรแกรมดึงข้อมูลจากไฟล์แล้วสร้างกราฟตามปีที่ input เข้าไป ต.ย.อยู่ที่ไฟล์ program
## ผลลัพธ์
